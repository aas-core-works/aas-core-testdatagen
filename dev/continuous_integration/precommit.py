...
def main() -> int:
    ...
    if Step.DOCTEST in selects and Step.DOCTEST not in skips:
        ...
        for pth in (repo_root / "aas_core_testdatagen").glob("**/*.py"):
    ...
    if (
        ...
        print(
            "Checking that aas_core_testdatagen/__init__.py "
            "and pyproject.toml coincide..."
        )
        exit_code = call_and_report(
            verb=(
                "check that aas_core_testdatagen/__init__.py "
                "and pyproject.toml coincide"
            ),
            cmd=[
                sys.executable,
        ...
        print(
            "Skipped checking that aas_core_testdatagen/__init__.py "
            "and pyproject.toml coincide..."
        )
